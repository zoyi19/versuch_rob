...
ENCODER_RANGE_TABLE = {
    ...
    17: {
        1: BIT_17_25, 2: BIT_17_25, 3: BIT_17_25, 4: BIT_17_25, 5: BIT_17_36, 6: BIT_17_36,
        7: BIT_17_25, 8: BIT_17_25, 9: BIT_17_25, 10: BIT_17_25, 11: BIT_17_36, 12: BIT_17_36,
        13: BIT_17_25
    },
    42: {
...
class EcMasterConfig:
    ...
    def get_robot_type_and_slave_num(self, robot_version):
        if robot_version == 13 or robot_version == 14:
            return "roban2", 13
        elif robot_version == 17:
            return "roban2", 13
        else:
            print(f"\033[31merror: 机器人版本 {robot_version} 不在支持范围内\033[0m", file=sys.stderr)
            print(f"\033[31m支持的版本: Roban2 (13-14, 17)\033[0m", file=sys.stderr)
            sys.exit(1)

    def get_ec_eni_config(self, driver_type, slave_num):
            return f"./config/ENI_config/yd300_{slave_num}_c500.xml"
