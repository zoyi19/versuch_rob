...
- [产品介绍](#产品介绍)
  - [产品组成](#产品组成)
  - [产品规格](#产品规格)
  - [KUAVO5MaxB自由度范围、速度扭矩限制关节位置及运动控制坐标系图示](#kuavo5maxb自由度范围速度扭矩限制关节位置及运动控制坐标系图示)
  - [KUAVO5MaxB电气接口](#kuavo5maxb电气接口)
    - [二合一板接口说明：](#二合一板接口说明)
  - [传感器参数](#传感器参数)
    - [IMU](#imu)
...
KUAVO机器人5代 MaxB版包含头、躯干、手臂、腿部，全身总共29个自由度（不含末端），使得机器人能够实现灵活的运动和姿态控制。
...
## KUAVO5MaxB自由度范围、速度扭矩限制关节位置及运动控制坐标系图示
