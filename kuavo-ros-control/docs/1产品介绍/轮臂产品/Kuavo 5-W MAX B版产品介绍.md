...
- [产品介绍](#产品介绍)
  - [产品组成](#产品组成)
  - [产品规格](#产品规格)
  - [Kuavo 5-W MaxB自由度范围、速度扭矩限制关节位置及运动控制坐标系图示](#kuavo-5-w-maxb自由度范围速度扭矩限制关节位置及运动控制坐标系图示)
  - [Kuavo 5-W MaxB电气接口](#kuavo-5-w-maxb电气接口)
    - [换电板接口说明：](#换电板接口说明)
    - [电源板接口说明:](#电源板接口说明)
  - [传感器参数](#传感器参数)
    - [IMU](#imu)
...
Kuavo轮臂机器人 5-W Max B版包含头、躯干、手臂，腰部全身总共36个自由度，使得机器人能够实现灵活的运动和姿态控制。
...
![Kuavo 5-W](images/五代_灵巧手机器人_渲染图.jpg)
...
| 自由度  | 全身自由度<br/>颈关节<br/>单臂自由度<br/>灵巧手<br/>腰部<br/>折叠臂<br/>底盘 | 36<br/>2<br/>7<br/>6<br/>1<br/>3<br/>4                          |
| 运行参数 | 行走速度<br/>行走模式                                                                    | 5.4km/h<br/>全向行走                                                      |
| 电池参数 | 工作电压<br/>电池容量<br/>充电方式                                | ≥48V<br/>50Ah+6Ah<br/>自动充、手动充电、手动换电                      |
| 传感器  | 摄像头（头部）<br/>摄像头（手腕）<br/>麦克风<br/>激光雷达<br/>扬声器<br/>关节温度传感器<br/>IMU                        | 立体视觉相机（1280×800@30fps景深/红外，1280×800@60fps RGB）<br/>D405 x 2<br/>6MIC  360度定位（选配）<br/>mid-360（选配）<br/>立体音响（选配）<br/>LB01<br/>俯仰/横滚0.2度，航向角漂移0.2度 |
...
## Kuavo 5-W MaxB自由度范围、速度扭矩限制关节位置及运动控制坐标系图示
