...
class config:
    ...
    class pick:
        ...
        stand_in_tag_pos = (-(0.3 + box_length/2), 0.0, -0.15-box_width/2)  # 站立位置在目标标签中的位置猜测，单位米
        ...
        tag_dy = 0.0  # 箱子在tag坐标系y方向偏移的距离，单位米
    ...
    class place:
        ...
        stand_in_tag_pos = (0.4 + box_length/2, 0.0, 0)  # 放置位置站立位置在目标标签中的位置猜测，单位米
        ...
        tag_dz = 0.0  # 箱子在tag坐标系z方向偏移的距离，单位米
