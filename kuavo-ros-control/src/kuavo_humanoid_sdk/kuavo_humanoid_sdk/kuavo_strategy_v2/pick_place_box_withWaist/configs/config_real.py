...
class config:
    ...
    class pick:
        """搬框配置"""
        tag_id = 5
        step_back_distance = -0.8
        side_shift_distance = 0.6
        ...
        stand_in_tag_pos = (-0.5, 0.0, -0.1)  # 站立位置在目标标签中的位置猜测，单位米
        ...
        box_beneath_tag = 0.02  # 箱子在tag下方的距离，单位米
    ...
    class place:
        ...
        box_beneath_tag = 0.6  # 箱子在tag下方的距离，单位米
