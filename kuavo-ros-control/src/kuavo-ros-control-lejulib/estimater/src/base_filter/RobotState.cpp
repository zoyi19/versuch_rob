...
#include "kuavo_estimation/base_filter/RobotState.h"
#include "kuavo_estimation/base_filter/LieGroup.h"
...
const Eigen::Vector3d RobotState::getAngularVelocity() { 
#if INEKF_USE_MUTEX
    unique_lock<mutex> mlock(mutex_);
#endif
    return V_; 
...
void RobotState::setAngularVelocity(const Eigen::Vector3d& v) { 
#if INEKF_USE_MUTEX
    unique_lock<mutex> mlock(mutex_);
#endif
    V_ = v; 
