#ifndef REVO1_HAND_CAN_CUSTOMED_H
#define REVO1_HAND_CAN_CUSTOMED_H
...
/**
 * @brief 基于CAN通信的  [Revo1灵巧手]
 *
 */
class Revo1CanDexhand: public ModbusDexhand {
public:
    ~Revo1CanDexhand();
     ...
     */
    static std::unique_ptr<Revo1CanDexhand> Connect(
     ...
     * @brief 设置抓力等级
     *
     * @warning Revo1灵巧手不支持设置抓力等级，此函数仅打印警告信息。
     *
     * @param level 抓力等级
     */
     ...
     * @brief 获取抓力等级
     *
     * @warning Revo1灵巧手不支持获取抓力等级，此函数仅打印警告信息并返回默认值。
     *
     * @return 默认抓力等级
     */
...
private:
     ...
     * @param config 设备配置信息
     */
    explicit Revo1CanDexhand(DeviceHandler* handle, uint8_t slave_id_, const canbus_sdk::DeviceConfig& config);
...
#endif // REVO1_HAND_CAN_CUSTOMED_H