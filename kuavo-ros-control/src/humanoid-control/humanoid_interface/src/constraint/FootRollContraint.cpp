...
namespace ocs2
{
    namespace humanoid
    {
        ...
        {
            // 获取最后一个关节的速度
            long index = 5 + (contactPointIndex_ / 2) * 6; // TODO: 修改contactPointIndex_的计算方式！！
            // 只适用于单足4接触点
            // long index = 5 + (contactPointIndex_ / 4) * 6 + contactPointIndex_;
            // if(contactPointIndex_ < 4)
            //      index = 5 + contactPointIndex_;
            // else if(contactPointIndex_ < 8)
            //      index = 5 + 6 + contactPointIndex_;
