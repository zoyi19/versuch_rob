...
from kuavo_msgs.msg import RobotActionState,robotWaistControl  # 导入自定义消息类型
...
if __name__ == '__main__':
    ...
    try:
        ...
        robot_walker.walk_forward(linear_speed_x=0.3, linear_speed_y = 0, angular_speed=0.0, duration = 2, waist_angle= 0)  
        robot_walker.walk_forward(linear_speed_x=0.2, linear_speed_y = 0, angular_speed=0.0, duration = 2, waist_angle = 90)
        robot_walker.arm_action('grap__box_stand') 
        robot_walker.arm_action('grap_8')
        # rospy.sleep(0)

        rospy.loginfo(f"开始直线行走")
        robot_walker.walk_forward(linear_speed_x=0.2, linear_speed_y = 0, angular_speed=0.0, duration = 2, waist_angle = 0)
        robot_walker.walk_forward(linear_speed_x=0.2, linear_speed_y = 0, angular_speed=0.0, duration = 1, waist_angle= 0)
        robot_walker.walk_forward(linear_speed_x=0.2, linear_speed_y = 0, angular_speed=0.0, duration = 2, waist_angle = -90)
        robot_walker.arm_action('down_1') 
        robot_walker.call_change_arm_ctrl_mode_service(1)
