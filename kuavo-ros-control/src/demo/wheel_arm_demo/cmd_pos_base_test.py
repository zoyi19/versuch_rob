...
def test_twist_callback():
    ...
    # 测试数据4：零值
    twist_msg4 = Twist()
    twist_msg4.linear.x = 0.0
    twist_msg4.linear.y = 2.0
    twist_msg4.linear.z = 0.0
    twist_msg4.angular.x = 0.0
    twist_msg4.angular.y = 0.0
    twist_msg4.angular.z = 1.57
    
    print("\n发布测试数据3（零值）:")
    print(f"  位置: ({twist_msg4.linear.x}, {twist_msg4.linear.y})")
    print(f"  偏航角: {twist_msg4.angular.z}")
